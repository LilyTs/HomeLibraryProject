...
const
  ...
  sqlGetBooksWithPubHouseName = 'SELECT B.Book_id, B.Name, B.Author, B.PubYear, PH.Name AS PubHouseName, B.PicAuthor, B.Translator, B.Comment, :Genres  AS Genres  FROM Book B JOIN PublishingHouse PH ON B.PubHouse_id = PH.PubHouse_id';
