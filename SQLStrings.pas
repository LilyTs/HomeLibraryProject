...
const
  ...
  sqlGetGenresWithParentName = 'SELECT G1.Genre_id, G1.Name, G2.Name AS ParentGenre FROM Genre G1 LEFT JOIN Genre G2 ON G1.ParentGenre_id = G2.Genre_id ORDER BY G1.Genre_id';
